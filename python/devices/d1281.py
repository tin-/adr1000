# -*- coding: utf-8 -*-
# $Id: devices/d1281.py | Rev 67  | 2023/10/30 05:06:48 tin_fpga $
...
class dat_meter():
    ...
    def __init__(self,gpib,reflevel,name):
        ...
        if cfg.get('teckit', 'interface') == 'gpib':
            ...
            self.inst = vxi11.Instrument(cfg.get('teckit', 'dvxi_ip'), "gpib0,%d" % self.gpib) # VXI link
...
#        #kei.write("READ?")
    ...
    def set_tohmf_range(self,cmd):
        ...
        self.inst.write("TRUE_OHMS RESL8,FAST_ON")
        self.inst.write("TRUE_OHMS LOI_OFF")
        self.inst.write("AVG OFF")
...
#        self.inst.write("DELAY 2")
    ...
    def set_dcv_fast_range(self,cmd):
        # Setup SCPI DMM
        self.inst.write("DCV %.3f,FILT_OFF,RESL6,FAST_ON" % cmd)
