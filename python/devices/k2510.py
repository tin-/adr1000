# -*- coding: utf-8 -*-
# $Id: devices/k2510.py | Rev 67  | 2023/10/30 05:06:48 tin_fpga $
...
class tec_meter():
    ...
    def init_inst(self):
        ...
        self.inst.write(":sour:temp:prot:high 55")  #75C max temp
        self.inst.write(":sour:temp:prot:low -25")   #15C min temp
    ...
    def init_inst_ysi44006(self):
        ...
        self.inst.write(":sour:temp:prot:low -20")   #15C min temp
        self.inst.write(":sour:temp:prot:state ON") #enable temp #protection (default)
